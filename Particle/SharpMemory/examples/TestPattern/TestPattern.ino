...
Modified By: Daniel Eisterhold
Changed to support my optimized (only updates lines that have changed) version of the library.
*********************************************************************/

#include <SharpMemory.h>

// Uncomment to use the second SPI Bus
//#undef SPI_BUS
//#define SPI_BUS SPI1
